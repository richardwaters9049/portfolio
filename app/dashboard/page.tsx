...
const Page: React.FC = () => {
    ...
    return (
        <>
            {showTransition && (
                <JasonVid onFinish={() => router.push("/projects")} />
            )}
                ...
                <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 p-8 justify-items-center items-start">
                    ...
                    >
                        ...
                        <div className="social-container mt-6">
                            <div className="social-inner-container p-6 rounded-lg grid grid-cols-3 gap-4 justify-items-center font-bitter">
                                <Link
                            ...
                            <div ref={copyContainerRef} className="flex gap-6 items-center mt-6">
                                ...
                                >
                                    <Button
                                        ref={buttonRef}
                                        className="text-white text-2xl px-6 py-7 font-angel bg-green-600 hover:bg-teal-900 transition-all shadow-lg shadow-cyan-900"
                                    >
